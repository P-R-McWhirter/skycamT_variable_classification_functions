bands <- function(x, filt, ofac = 1, from = 0.001, to = 20, nt = 150, b = 3) {
  ...
  plot(freq, Sj[,2], type = "l", col = "red", main = "Band Method power spectrum", xlab = "Frequency (Cycles/day)", ylab = "Spectral Power")
  
  lines(freq, Sj[,3], col = "blue")
  
  lines(freq, Sj[,4], col = "green")
...
bands2 <- function(x, ofac = 1, from = 0.001, to = 20, nt = 150, b = 3) {
  ...
  try(lines(freq, Sj[,3], col = "blue"), TRUE)
  
  try(lines(freq, Sj[,4], col = "green"), TRUE)
